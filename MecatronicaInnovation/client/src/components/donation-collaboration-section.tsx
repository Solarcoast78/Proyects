...
export default function DonationCollaborationSection() {
  ...
  const donationMutation = useMutation({
    mutationFn: (data: any) => apiRequest('/api/collaboration', 'POST', { ...data, requestType: 'donation' }),
    onSuccess: () => {
  ...
  const collaborationMutation = useMutation({
    mutationFn: (data: any) => apiRequest('/api/collaboration', 'POST', { ...data, requestType: 'collaboration' }),
    onSuccess: () => {
    ...
    <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Únete a Nuestro Crecimiento</h2>
          ...
          <Card className="shadow-xl">
            <CardHeader>
              <CardTitle className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Apoya Nuestro Crecimiento</h3>
                  <p className="text-gray-600 font-normal">Donaciones para equipo creciente</p>
                </div>
              </CardTitle>
            </CardHeader>
          ...
          <Card className="shadow-xl">
            <CardHeader>
              <CardTitle className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Colabora Con Nosotros</h3>
                  <p className="text-gray-600 font-normal">Solicitudes de colaboración</p>
                </div>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
